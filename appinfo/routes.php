...
return [
    ...
    'routes' => [
        ...
        ['name' => 'api#movePage', 'url' => '/api/pages/move', 'verb' => 'POST'],
        ...
        ['name' => 'publicShare#getPageByShare', 'url' => '/api/share/{token}/page/{uniqueId}', 'verb' => 'GET'],
        ['name' => 'publicShare#getMediaByShare', 'url' => '/api/share/{token}/page/{uniqueId}/media/{filename}', 'verb' => 'GET'],
        ['name' => 'publicShare#getResourcesMediaByShare', 'url' => '/api/share/{token}/resources/media/{filename}', 'verb' => 'GET'],
        ['name' => 'publicShare#getResourcesMediaWithFolderByShare', 'url' => '/api/share/{token}/resources/media/{folder}/{filename}', 'verb' => 'GET'],
