OC.L10N.register(
    ...
    "Delete" : "Удалить",
    "Toggle connection details" : "Переключить видимость деталей подключения",
    "New connection" : "Новое соединение",
    "Active" : "Активно",
    "Inactive" : "Неактивно",
    "Name" : "Имя",
    "e.g. Canvas University" : "напр. Университет Canvas",
    "Type" : "Тип",
    ...
    "Smallest first" : "Самый маленький первый",
    ...
    "Send" : "Отправить",
    "You and {count} others reacted with {emoji}" : "Вы и {count} других отреагировали с {emoji}",
    "{count} people reacted with {emoji}" : "{count} людей реагировали с {emoji}"
},
