OC.L10N.register(
    "intravox",
    {
    "You viewed \"%s\"" : "Shlédl jsi \"%s\"",
    "You created page \"%s\"" : "Vytvořil jsi stránku \"%s\"",
    "You updated page \"%s\"" : "Upravil jsi stránku \"%s\"",
    "You deleted page \"%s\"" : "Smazal jsi stránku \"%s\"",
    "You commented on \"%s\"" : "Okomentoval jsi \"%s\"",
    "You reacted to \"%s\"" : "Reagoval jsi na \"%s\"",
    "PDF" : "PDF",
    ...
    "This page is in {language}, not your own language. Editing it saves back to {language}." : "Tato stránka je k dispozici v {language}, ale ne v tvém jazyce. Po úpravě bude uložena zpět v {language}.",
    "Published" : "Zveřejněno",
    "Could not load pages: {error}" : "Nelze načíst stránky: {error}",
    "Open a page first" : "Nejdřív načti stránku",
