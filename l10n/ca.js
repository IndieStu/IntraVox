OC.L10N.register(
    ...
    "Send" : "Envia",
    "You and {count} others reacted with {emoji}" : "Vós i {count} persones més heu reaccionat amb {emoji}",
    "{count} people reacted with {emoji}" : "{count} persones han reaccionat amb {emoji}"
},
